    ...
    <main class="px-4 py-6 sm:px-6 lg:px-8">
      <div :class="containerClass">
        ...
        <section class="mt-12 rounded-[32px] border border-slate-950/10 bg-white/82 p-8 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur-[10px] sm:p-10 lg:p-14">
          <div class="max-w-3xl">
            <p class="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">Sunset deck</p>
            <h1 class="mt-4 text-4xl font-bold tracking-[-0.04em] text-slate-950 sm:text-5xl">A sunset gallery</h1>
            <p class="mt-5 max-w-2xl text-lg leading-8 text-slate-700">
              Explore the sunset deck through a gallery of golden-hour skies, terrace seating, and warm evening views.
            </p>
          </div>
          ...
          <div class="mt-10 flex flex-col gap-4 rounded-3xl border border-slate-950/10 bg-gradient-to-r from-amber-50 via-white to-orange-50 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p class="text-sm font-semibold uppercase tracking-[0.24em] text-slate-500">Deck highlights</p>
              <p class="mt-2 text-base text-slate-900">Open-air sunsets, warm seating, and quiet afterglow views.</p>
            </div>
...
useHead({
  title: 'Sunset deck | RA7 Resort',
  meta: [
    { name: 'description', content: 'Explore the RA7 sunset deck through a gallery of golden-hour views, terrace meals, and evening lounge moments.' }
  ]
})
...
const galleryItems = [
  { title: 'Sunset terrace view', tag: 'Golden hour', desc: 'Wide-open views capture the resort’s most iconic evening light.', image: '/images/landscape11.jpg' },
  { title: 'Deck seating', tag: 'Warm calm', desc: 'Comfortable seating and gentle lighting create a chilled sunset moment.', image: '/images/landscape12.jpg' },
  { title: 'Sky color wash', tag: 'Evening palette', desc: 'Vibrant sky tones highlight the resort’s peaceful nightfall setting.', image: '/images/landscape13.jpg' },
  { title: 'Open-air lounge', tag: 'Relaxed pause', desc: 'A mellow lounge area perfect for quiet conversation and sunset sipping.', image: '/images/landscape10.jpg' },
]
</script>
