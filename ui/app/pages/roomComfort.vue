  ...
  <div class="min-h-screen bg-[#f5f7fb] text-slate-950/92 [background:radial-gradient(1200px_600px_at_12%_6%,rgba(245,197,66,0.08),transparent_58%),radial-gradient(900px_520px_at_92%_12%,rgba(245,158,11,0.06),transparent_58%),#f5f7fb]">
    <main class="px-4 py-6 sm:px-6 lg:px-8">
      <div :class="containerClass">
        <NuxtLink to="/#gallery" class="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white/90 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition duration-200 hover:border-amber-300 hover:text-amber-700">
          ← Back to gallery
        </NuxtLink>
        ...
        <section class="mt-12 rounded-[32px] border border-slate-950/10 bg-white/82 p-8 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur-[10px] sm:p-10 lg:p-14">
          <div class="max-w-3xl">
            <p class="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">Room comfort</p>
            <h1 class="mt-4 text-4xl font-bold tracking-[-0.04em] text-slate-950 sm:text-5xl">A room gallery</h1>
            <p class="mt-5 max-w-2xl text-lg leading-8 text-slate-700">
              Discover RA7’s rooms through a visual gallery of soft beds, warm atmospheres, and soothing details.
            </p>
          </div>
          ...
          <div class="mt-10 flex flex-col gap-4 rounded-3xl border border-slate-950/10 bg-gradient-to-r from-amber-50 via-white to-orange-50 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p class="text-sm font-semibold uppercase tracking-[0.24em] text-slate-500">Room highlights</p>
              <p class="mt-2 text-base text-slate-900">Restful rooms with layered bedding, calm details, and balanced lighting.</p>
            </div>
...
useHead({
  title: 'Room comfort | RA7 Resort',
  meta: [
    { name: 'description', content: 'View RA7 Resort rooms designed for comfort, calm, and a restful island stay through a gallery of images.' }
  ]
})
...
const galleryItems = [
  { title: 'Relaxing bed setup', tag: 'Soft linens', desc: 'Cozy layered bedding and soothing textures set the tone for restful nights.', image: '/images/landscape4.jpg' },
  { title: 'Warm wood accents', tag: 'Natural feel', desc: 'Curated materials and calming hues make each room feel inviting and serene.', image: '/images/landscape8.jpg' },
  { title: 'Quiet reading corner', tag: 'Calm nook', desc: 'A soft chair and gentle lighting provide a quiet place to unwind at the end of the day.', image: '/images/landscape2.jpg' },
  { title: 'Open room atmosphere', tag: 'Breathe easy', desc: 'Light, airy room layouts create a relaxed space for rest and quiet reflection.', image: '/images/landscape3.jpg' },
]
</script>
