    ...
    <div class="mx-auto max-w-7xl space-y-8 px-6 py-12">
      ...
      >
        <div class="mb-5 grid gap-2">
          <h2 class="m-0 text-4xl font-bold tracking-[-0.4px] text-slate-950/92">Standard Gallery</h2>
          <p class="m-0 max-w-[70ch] text-base leading-normal text-slate-950/66">Explore our comfortable and practical Standard rooms, perfect for budget-conscious travelers.</p>
        </div>

        <div class="grid grid-cols-1 gap-3 min-[860px]:grid-cols-2">
          <!-- @ts-ignore motion-v type incompatibility -->
          <Motion
            v-for="(item, index) in standardGalleryItems"
            :key="item.title"
            as="article"
            :initial="cardInitial"
      ...
      >
        <div class="grid grid-cols-1 gap-6 p-6 min-[860px]:p-8 min-[860px]:grid-cols-[1.2fr_0.8fr] min-[860px]:gap-8">
          ...
          <div class="flex flex-col justify-between">
            <div>
              <p class="m-0 text-xs font-bold uppercase tracking-[0.24em] text-amber-600">Essential Comfort</p>
              <h3 class="m-0 mt-3 text-3xl font-bold tracking-[-0.6px] text-slate-950/92">Standard Room</h3>
              <p class="m-0 mt-4 text-base leading-relaxed text-slate-950/72">Our Standard rooms offer excellent value without compromising on comfort. Featuring all the essentials for a pleasant stay, these rooms are perfect for travelers seeking affordable accommodation with modern amenities.</p>
              ...
              <div class="mt-6 space-y-2">
                ...
                <div class="flex items-center gap-3 text-sm text-slate-950/72">
                  ...
                  <span><strong>Beds:</strong> 1 Queen Bed</span>
                </div>
                <div class="flex items-center gap-3 text-sm text-slate-950/72">
                  <span class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-amber-100/60 text-amber-700 text-xs font-bold">📐</span>
                  <span><strong>Size:</strong> 30 m²</span>
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div class="space-y-3 text-sm">
            <div class="rounded-lg bg-amber-50/60 p-4 border border-amber-200/40">
              ...
              <div class="text-slate-950/66">Simple, functional entrance area.</div>
            </div>
            <div class="rounded-lg bg-amber-50/60 p-4 border border-amber-200/40">
              <div class="font-bold text-amber-900/80 mb-2">🛏️ Bedroom</div>
              <div class="text-slate-950/66">Compact sleeping area with comfortable bed.</div>
            </div>
            <div class="rounded-lg bg-amber-50/60 p-4 border border-amber-200/40">
              <div class="font-bold text-amber-900/80 mb-2">🚿 Bathroom</div>
              <div class="text-slate-950/66">Essential bathroom with shower facilities.</div>
            </div>
          </div>
        </Motion>
          ...
          <div class="space-y-3">
            <div class="flex items-start gap-3 rounded-lg bg-linear-to-r from-amber-50/80 to-amber-50/40 p-4 border border-amber-200/40">
              ...
              <div>
                ...
                <div class="text-sm text-slate-950/66">Keeps your room at ideal temperature</div>
              </div>
            </div>
            <div class="flex items-start gap-3 rounded-lg bg-linear-to-r from-amber-50/80 to-amber-50/40 p-4 border border-amber-200/40">
              <div class="text-2xl">📺</div>
              <div>
                <div class="font-bold text-slate-950/92">TV</div>
                <div class="text-sm text-slate-950/66">Entertainment with local channels</div>
              </div>
            </div>
            <div class="flex items-start gap-3 rounded-lg bg-linear-to-r from-amber-50/80 to-amber-50/40 p-4 border border-amber-200/40">
              <div class="text-2xl">☕</div>
              <div>
                ...
                <div class="text-sm text-slate-950/66">In-room beverage station</div>
              </div>
            </div>
            <div class="flex items-start gap-3 rounded-lg bg-linear-to-r from-amber-50/80 to-amber-50/40 p-4 border border-amber-200/40">
              <div class="text-2xl">📶</div>
              <div>
                ...
                <div class="text-sm text-slate-950/66">Internet access throughout room</div>
              </div>
            </div>
            <div class="flex items-start gap-3 rounded-lg bg-linear-to-r from-amber-50/80 to-amber-50/40 p-4 border border-amber-200/40">
              <div class="text-2xl">🧺</div>
              <div>
                <div class="font-bold text-slate-950/92">Daily Housekeeping</div>
                <div class="text-sm text-slate-950/66">Room cleaning and maintenance</div>
              </div>
            </div>
          </div>
        </Motion>
...
useHead({
  title: 'Standard Room - RA7 Resort',
  meta: [
    { name: 'description', content: 'Affordable comfort in our Standard Room. 30 m², perfect for 2 guests. All essential modern amenities included.' },
    { property: 'og:title', content: 'Standard Room - RA7 Resort' },
    { property: 'og:description', content: 'Affordable comfort in our Standard Room. 30 m², perfect for 2 guests with modern amenities.' },
  ],
})
