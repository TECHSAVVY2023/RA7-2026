    ...
    <main class="px-4 py-6 sm:px-6 lg:px-8">
      <div :class="containerClass">
        ...
        <section class="mt-12 rounded-[32px] border border-slate-950/10 bg-white/82 p-8 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur-[10px] sm:p-10 lg:p-14">
          <div class="max-w-3xl">
            <p class="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">Dining corner</p>
            <h1 class="mt-4 text-4xl font-bold tracking-[-0.04em] text-slate-950 sm:text-5xl">A dining gallery</h1>
            <p class="mt-5 max-w-2xl text-lg leading-8 text-slate-700">
              Explore RA7’s dining corner through imagery of breakfast moments, relaxed meals, and ambient dining details.
            </p>
          </div>
          ...
          <div class="mt-10 flex flex-col gap-4 rounded-3xl border border-slate-950/10 bg-gradient-to-r from-amber-50 via-white to-orange-50 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p class="text-sm font-semibold uppercase tracking-[0.24em] text-slate-500">Dining highlights</p>
              <p class="mt-2 text-base text-slate-900">Fresh meals, gentle ambiance, and easy dining for resort moments.</p>
            </div>
...
useHead({
  title: 'Dining corner | RA7 Resort',
  meta: [
    { name: 'description', content: 'Discover RA7 Resort’s dining corner through a gallery of fresh plate styling, relaxed meal spaces, and calm service.' }
  ]
})
...
const galleryItems = [
  { title: 'Breakfast spread', tag: 'Morning light', desc: 'Fresh mornings at the dining corner with bright plates and warm coffee.', image: '/images/landscape6.jpg' },
  { title: 'Casual lunch seating', tag: 'Easy meals', desc: 'A relaxed dining table set for simple, satisfying resort dishes.', image: '/images/landscape12.jpg' },
  { title: 'Evening dining glow', tag: 'Warm ambiance', desc: 'Soft lighting and calm surroundings make dinner feel effortless.', image: '/images/landscape13.jpg' },
  { title: 'Fresh detail styling', tag: 'Seasonal plates', desc: 'Thoughtful plate styling enhances the dining corner’s fresh resort experience.', image: '/images/landscape10.jpg' },
]
</script>
